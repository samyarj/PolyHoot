String getCoinSvg(int value) {
  if (value >= 0 && value < 25) {
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="128" height="128" viewBox="0 0 24 24">
                                ...
                                ''';
  } else if (value >= 250 && value < 5000000) {
    return '''
   <svg xmlns="http://www.w3.org/2000/svg" width="128" height="128" viewBox="0 0 16 16">
    ...
    return ''; // Return an empty string or a default SVG if the value doesn't match any range
  }
}
